...
void setup()
{
  size(512, 200);
    ...
    s1 = new SoundFile(this, notesounds[floor(random(notesounds.length))]);
    s2 = new SoundFile(this, notesounds[floor(random(notesounds.length))]);
    s3 = new SoundFile(this, notesounds[floor(random(notesounds.length))]);
    s4 = new SoundFile(this, notesounds[floor(random(notesounds.length))]);
    s5 = new SoundFile(this, notesounds[floor(random(notesounds.length))]);
    s6 = new SoundFile(this, notesounds[floor(random(notesounds.length))]);
}
